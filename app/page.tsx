export default function Home() {
  return (
    <div className="min-h-screen bg-[#faf9f6] dark:bg-[#1a1816]">
      {/* Navigation */}
      ...
      <section className="pt-32 pb-24 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-10 text-[#1a1816] dark:text-[#f5f3ee] leading-[1.1] tracking-tight">
              Discover the joy of algorithms
            </h1>

            <p className="text-xl sm:text-2xl text-[#5c5653] dark:text-[#a39c94] mb-14 leading-relaxed max-w-2xl mx-auto">
      ...
      <section id="features" className="py-32 px-6 lg:px-8 border-t border-[#e8e3db] dark:border-[#2d2a26]">
        <div className="max-w-5xl mx-auto">
          <div className="mb-20">
            <h2 className="font-serif text-5xl sm:text-6xl font-bold text-[#1a1816] dark:text-[#f5f3ee] mb-6 tracking-tight">
              Built for learners
            </h2>
          ...
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              <div className="h-64 bg-[#e8e3db] dark:bg-[#2d2a26] rounded-sm md:order-1"></div>
            </div>
      ...
      <section className="py-32 px-6 lg:px-8 border-t border-[#e8e3db] dark:border-[#2d2a26]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-serif text-5xl sm:text-6xl font-bold text-[#1a1816] dark:text-[#f5f3ee] mb-8 tracking-tight">
            Begin your journey
          </h2>
      ...
      <footer className="py-16 px-6 lg:px-8 border-t border-[#e8e3db] dark:border-[#2d2a26]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="pt-8 border-t border-[#e8e3db] dark:border-[#2d2a26] flex flex-col md:flex-row justify-between items-center gap-4">
